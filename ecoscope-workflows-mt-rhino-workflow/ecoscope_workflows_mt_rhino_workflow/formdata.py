...
class ProcessPatrols(BaseModel):
    patrol_traj: PatrolTraj | None = Field(None, title="Convert to Trajectories")
...
class FormData(BaseModel):
    ...
    Process_Patrols: ProcessPatrols | None = Field(
        None,
    ...
    rhino_report: RhinoReport | None = Field(None, title="Create Rhino Report")
